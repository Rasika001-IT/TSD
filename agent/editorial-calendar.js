...
// The editorial publishing calendar from the TSD standards docs (Website
// Segments / Editorial Publishing Calendar). Three weekday anchor streams plus
// daily news and a weekly newsletter — the day-of-week "slots" readers learn to
// expect. The dashboard renders and toggles these; stored in app_settings under
// "editorial_schedule". `live` marks streams the generation engine already
// drafts (news today); the rest are scheduled here but generated by a later
// build, so the UI can flag them as planned.
export const DEFAULT_EDITORIAL_SCHEDULE = Object.freeze([
  ...
  { id: 'sat-reports', day: 'Saturday', stream: 'reports', label: 'Reports & Research',
    description: 'TSD Insights (weeks 1, 3) or Market Pulse / Industry Report (weeks 2, 4)', enabled: true, live: false },
  { id: 'weekly-newsletter', day: 'Weekly', stream: 'newsletter', label: 'Newsletter',
    description: 'Weekly editorial roundup', enabled: false, live: false },
]);
